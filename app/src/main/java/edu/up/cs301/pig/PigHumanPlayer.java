...
public class PigHumanPlayer extends GameHumanPlayer implements OnClickListener {
    ...
    public void receiveInfo(GameInfo info) {
        ...
        if (super.playerNum == 0) {
            playerScoreTextView.setText(" " + tempState.getP1Score());
            oppScoreTextView.setText(" " + tempState.getP2Score());
        } else {
            playerScoreTextView.setText(" " + tempState.getP2Score());
            oppScoreTextView.setText(" " + tempState.getP1Score());
        }
        turnTotalTextView.setText(" " + tempState.getRunningTotal());

        switch (tempState.getDiceVal()) {
            case 1:
